 ...
 * 接口remark：
 */
public abstract class AbstractSubOrderSignDelegate implements Cloneable {
     ...
     * 需子类实现。
     */
    public abstract AbstractSubOrderSignDelegate clone() throws CloneNotSupportedException;
    ...
    public final void init(final BaseInputBean inputBean, final BaseOutputBean outputBean) throws OmsDelegateException {
        ...
        if (inputBean.getInputData() != null) {
            if (!(inputBean.getInputData() instanceof OmsSubOrderSignInputData)) {
        ...
        /*调用子类方法。*/
        doInit(inputBean.getInputHead(), (OmsSubOrderSignInputData)inputBean.getInputData(), outputBean.getOutputHead(), (OmsSubOrderSignOutputData)outputBean.getOutputData());
    }
    ...
    public final boolean check(final BaseInputBean inputBean, final BaseOutputBean outputBean) {
        ...
        /*调用子类方法。*/
        return doCheck(inputBean.getInputHead(), (OmsSubOrderSignInputData)inputBean.getInputData(), outputBean.getOutputHead(), (OmsSubOrderSignOutputData)outputBean.getOutputData());
    }
    ...
    public final void execute(final BaseInputBean inputBean, final BaseOutputBean outputBean) throws OmsDelegateException {
        ...
        /*调用子类方法。*/
        doExecute(inputBean.getInputHead(), (OmsSubOrderSignInputData)inputBean.getInputData(), outputBean.getOutputHead(), (OmsSubOrderSignOutputData)outputBean.getOutputData());
    }
    ...
    public final void close(final BaseInputBean inputBean, final BaseOutputBean outputBean) throws OmsDelegateException {
        ...
        /*调用子类方法。*/
        doClose(inputBean.getInputHead(), (OmsSubOrderSignInputData)inputBean.getInputData(), outputBean.getOutputHead(), (OmsSubOrderSignOutputData)outputBean.getOutputData());
    }
     ...
     */
    public abstract void doInit(final BaseInputHead inputHead, final OmsSubOrderSignInputData inputData, final BaseOutputHead outputHead, final OmsSubOrderSignOutputData outputData) throws OmsDelegateException;
     ...
     * @return boolean 检查是否通过。
     */
    public abstract boolean doCheck(final BaseInputHead inputHead, final OmsSubOrderSignInputData inputData, final BaseOutputHead outputHead, final OmsSubOrderSignOutputData outputData);
     ...
     * @param outputData 该接口的返回结果数据体。
     */
    public abstract void doExecute(final BaseInputHead inputHead, final OmsSubOrderSignInputData inputData, final BaseOutputHead outputHead, final OmsSubOrderSignOutputData outputData) throws OmsDelegateException;
     ...
     * @param outputData 该接口的返回结果数据体。
     */
    public abstract void doClose(final BaseInputHead inputHead, final OmsSubOrderSignInputData inputData, final BaseOutputHead outputHead, final OmsSubOrderSignOutputData outputData) throws OmsDelegateException;
}
 ...
 * 服务description：订单服务。
 * 服务remark：订单服务。
 * 接口description：获取订单详情
 * 接口remark：流水信息建议放到单独的接口中异步加载
 */
public abstract class AbstractGetOrderDetailDelegate implements Cloneable {
     ...
     * 需子类实现。
     */
    public abstract AbstractGetOrderDetailDelegate clone() throws CloneNotSupportedException;
    ...
    public final void init(final BaseInputBean inputBean, final BaseOutputBean outputBean) throws OmsDelegateException {
        ...
        if (inputBean.getInputData() != null) {
            if (!(inputBean.getInputData() instanceof OmsGetOrderDetailInputData)) {
        ...
        /*调用子类方法。*/
        doInit(inputBean.getInputHead(), (OmsGetOrderDetailInputData)inputBean.getInputData(), outputBean.getOutputHead(), (OmsGetOrderDetailOutputData)outputBean.getOutputData());
    }
    ...
    public final boolean check(final BaseInputBean inputBean, final BaseOutputBean outputBean) {
        ...
        /*调用子类方法。*/
        return doCheck(inputBean.getInputHead(), (OmsGetOrderDetailInputData)inputBean.getInputData(), outputBean.getOutputHead(), (OmsGetOrderDetailOutputData)outputBean.getOutputData());
    }
    ...
    public final void execute(final BaseInputBean inputBean, final BaseOutputBean outputBean) throws OmsDelegateException {
        ...
        /*调用子类方法。*/
        doExecute(inputBean.getInputHead(), (OmsGetOrderDetailInputData)inputBean.getInputData(), outputBean.getOutputHead(), (OmsGetOrderDetailOutputData)outputBean.getOutputData());
    }
    ...
    public final void close(final BaseInputBean inputBean, final BaseOutputBean outputBean) throws OmsDelegateException {
        ...
        /*调用子类方法。*/
        doClose(inputBean.getInputHead(), (OmsGetOrderDetailInputData)inputBean.getInputData(), outputBean.getOutputHead(), (OmsGetOrderDetailOutputData)outputBean.getOutputData());
    }
     ...
     */
    public abstract void doInit(final BaseInputHead inputHead, final OmsGetOrderDetailInputData inputData, final BaseOutputHead outputHead, final OmsGetOrderDetailOutputData outputData) throws OmsDelegateException;
     ...
     * @return boolean 检查是否通过。
     */
    public abstract boolean doCheck(final BaseInputHead inputHead, final OmsGetOrderDetailInputData inputData, final BaseOutputHead outputHead, final OmsGetOrderDetailOutputData outputData);
     ...
     * @param outputData 该接口的返回结果数据体。
     */
    public abstract void doExecute(final BaseInputHead inputHead, final OmsGetOrderDetailInputData inputData, final BaseOutputHead outputHead, final OmsGetOrderDetailOutputData outputData) throws OmsDelegateException;
     ...
     * @param outputData 该接口的返回结果数据体。
     */
    public abstract void doClose(final BaseInputHead inputHead, final OmsGetOrderDetailInputData inputData, final BaseOutputHead outputHead, final OmsGetOrderDetailOutputData outputData) throws OmsDelegateException;
}
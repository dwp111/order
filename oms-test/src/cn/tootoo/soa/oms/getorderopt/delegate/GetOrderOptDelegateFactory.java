 ...
 */
public final class GetOrderOptDelegateFactory {
    
    /**
     * 服务委托者原型对象。
     */
    private static AbstractGetOrderOptDelegate prototype = null;
    
    /**
     * 服务委托者原型注册方法。
     */
    public static final void registPrototype(AbstractGetOrderOptDelegate inPrototype) {
        if (inPrototype == null) {
     ...
     */
    public static final AbstractGetOrderOptDelegate createDelegate() {
        if (prototype == null) {

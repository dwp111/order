package cn.tootoo.soa.oms.thirdordercancel;
...
import cn.tootoo.soa.oms.thirdordercancel.delegate.AbstractThirdOrderCancelDelegate;
import cn.tootoo.soa.oms.thirdordercancel.delegate.ThirdOrderCancelDelegateFactory;
 ...
 * 接口remark：
 */
public final class ThirdOrderCancelImpl extends BaseService {
    
    static {
        try {
            Class.forName("cn.tootoo.soa.oms.thirdordercancel.delegate.ThirdOrderCancelDelegate");
        } catch (ClassNotFoundException e) {
            Logger.getLogger(ThirdOrderCancelImpl.class.getName()).error("cn.tootoo.soa.oms.thirdordercancel.delegate.ThirdOrderCancelDelegate未找到！", e);
        }
    }
     ...
     * 日志对象。
     */
    private Logger logger = Logger.getLogger(ThirdOrderCancelImpl.class);
    
    /**
     * 构造函数。
     */
    public ThirdOrderCancelImpl() {
        /*如果捕获到未知异常，则在此处统一处理。*/
    ...
    public BaseOutputBean doService(BaseInputBean inputBean) throws Exception {
        ...
        /*实例化返回结果数据体。*/
        final OmsThirdOrderCancelOutputData outputData = new OmsThirdOrderCancelOutputData();
        outputBean.setOutputData(outputData);
        /*实例化服务委托者。*/
        final AbstractThirdOrderCancelDelegate delegate = ThirdOrderCancelDelegateFactory.createDelegate();
        /*将生成服务执行标识设置到服务委托者中。*/
    ...
    public BaseService clone() throws CloneNotSupportedException {
        return new ThirdOrderCancelImpl();
    }

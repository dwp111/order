 ...
 * 接口remark：
 */
public abstract class AbstractThirdOrderCancelDelegate implements Cloneable {
     ...
     * 需子类实现。
     */
    public abstract AbstractThirdOrderCancelDelegate clone() throws CloneNotSupportedException;
    ...
    public final void init(final BaseInputBean inputBean, final BaseOutputBean outputBean) throws OmsDelegateException {
        ...
        if (inputBean.getInputData() != null) {
            if (!(inputBean.getInputData() instanceof OmsThirdOrderCancelInputData)) {
        ...
        /*调用子类方法。*/
        doInit(inputBean.getInputHead(), (OmsThirdOrderCancelInputData)inputBean.getInputData(), outputBean.getOutputHead(), (OmsThirdOrderCancelOutputData)outputBean.getOutputData());
    }
    ...
    public final boolean check(final BaseInputBean inputBean, final BaseOutputBean outputBean) {
        ...
        /*调用子类方法。*/
        return doCheck(inputBean.getInputHead(), (OmsThirdOrderCancelInputData)inputBean.getInputData(), outputBean.getOutputHead(), (OmsThirdOrderCancelOutputData)outputBean.getOutputData());
    }
    ...
    public final void execute(final BaseInputBean inputBean, final BaseOutputBean outputBean) throws OmsDelegateException {
        ...
        /*调用子类方法。*/
        doExecute(inputBean.getInputHead(), (OmsThirdOrderCancelInputData)inputBean.getInputData(), outputBean.getOutputHead(), (OmsThirdOrderCancelOutputData)outputBean.getOutputData());
    }
    ...
    public final void close(final BaseInputBean inputBean, final BaseOutputBean outputBean) throws OmsDelegateException {
        ...
        /*调用子类方法。*/
        doClose(inputBean.getInputHead(), (OmsThirdOrderCancelInputData)inputBean.getInputData(), outputBean.getOutputHead(), (OmsThirdOrderCancelOutputData)outputBean.getOutputData());
    }
     ...
     */
    public abstract void doInit(final BaseInputHead inputHead, final OmsThirdOrderCancelInputData inputData, final BaseOutputHead outputHead, final OmsThirdOrderCancelOutputData outputData) throws OmsDelegateException;
     ...
     * @return boolean 检查是否通过。
     */
    public abstract boolean doCheck(final BaseInputHead inputHead, final OmsThirdOrderCancelInputData inputData, final BaseOutputHead outputHead, final OmsThirdOrderCancelOutputData outputData);
     ...
     * @param outputData 该接口的返回结果数据体。
     */
    public abstract void doExecute(final BaseInputHead inputHead, final OmsThirdOrderCancelInputData inputData, final BaseOutputHead outputHead, final OmsThirdOrderCancelOutputData outputData) throws OmsDelegateException;
     ...
     * @param outputData 该接口的返回结果数据体。
     */
    public abstract void doClose(final BaseInputHead inputHead, final OmsThirdOrderCancelInputData inputData, final BaseOutputHead outputHead, final OmsThirdOrderCancelOutputData outputData) throws OmsDelegateException;
}
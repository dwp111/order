 ...
 * 接口remark：
 */
public final class ThirdOrderCancelDelegateFactory {
    
    /**
     * 服务委托者原型对象。
     */
    private static AbstractThirdOrderCancelDelegate prototype = null;
    
    /**
     * 服务委托者原型注册方法。
     */
    public static final void registPrototype(AbstractThirdOrderCancelDelegate inPrototype) {
        if (inPrototype == null) {
     ...
     */
    public static final AbstractThirdOrderCancelDelegate createDelegate() {
        if (prototype == null) {

 ...
 * 接口remark：
 */
public abstract class AbstractSubOrderReturnDelegate implements Cloneable {
     ...
     * 需子类实现。
     */
    public abstract AbstractSubOrderReturnDelegate clone() throws CloneNotSupportedException;
    ...
    public final void init(final BaseInputBean inputBean, final BaseOutputBean outputBean) throws OmsDelegateException {
        ...
        if (inputBean.getInputData() != null) {
            if (!(inputBean.getInputData() instanceof OmsSubOrderReturnInputData)) {
        ...
        /*调用子类方法。*/
        doInit(inputBean.getInputHead(), (OmsSubOrderReturnInputData)inputBean.getInputData(), outputBean.getOutputHead(), (OmsSubOrderReturnOutputData)outputBean.getOutputData());
    }
    ...
    public final boolean check(final BaseInputBean inputBean, final BaseOutputBean outputBean) {
        ...
        /*调用子类方法。*/
        return doCheck(inputBean.getInputHead(), (OmsSubOrderReturnInputData)inputBean.getInputData(), outputBean.getOutputHead(), (OmsSubOrderReturnOutputData)outputBean.getOutputData());
    }
    ...
    public final void execute(final BaseInputBean inputBean, final BaseOutputBean outputBean) throws OmsDelegateException {
        ...
        /*调用子类方法。*/
        doExecute(inputBean.getInputHead(), (OmsSubOrderReturnInputData)inputBean.getInputData(), outputBean.getOutputHead(), (OmsSubOrderReturnOutputData)outputBean.getOutputData());
    }
    ...
    public final void close(final BaseInputBean inputBean, final BaseOutputBean outputBean) throws OmsDelegateException {
        ...
        /*调用子类方法。*/
        doClose(inputBean.getInputHead(), (OmsSubOrderReturnInputData)inputBean.getInputData(), outputBean.getOutputHead(), (OmsSubOrderReturnOutputData)outputBean.getOutputData());
    }
     ...
     */
    public abstract void doInit(final BaseInputHead inputHead, final OmsSubOrderReturnInputData inputData, final BaseOutputHead outputHead, final OmsSubOrderReturnOutputData outputData) throws OmsDelegateException;
     ...
     * @return boolean 检查是否通过。
     */
    public abstract boolean doCheck(final BaseInputHead inputHead, final OmsSubOrderReturnInputData inputData, final BaseOutputHead outputHead, final OmsSubOrderReturnOutputData outputData);
     ...
     * @param outputData 该接口的返回结果数据体。
     */
    public abstract void doExecute(final BaseInputHead inputHead, final OmsSubOrderReturnInputData inputData, final BaseOutputHead outputHead, final OmsSubOrderReturnOutputData outputData) throws OmsDelegateException;
     ...
     * @param outputData 该接口的返回结果数据体。
     */
    public abstract void doClose(final BaseInputHead inputHead, final OmsSubOrderReturnInputData inputData, final BaseOutputHead outputHead, final OmsSubOrderReturnOutputData outputData) throws OmsDelegateException;
}
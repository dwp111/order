 ...
 * 接口remark：
 */
public final class SubOrderReturnDelegateFactory {
    
    /**
     * 服务委托者原型对象。
     */
    private static AbstractSubOrderReturnDelegate prototype = null;
    
    /**
     * 服务委托者原型注册方法。
     */
    public static final void registPrototype(AbstractSubOrderReturnDelegate inPrototype) {
        if (inPrototype == null) {
     ...
     */
    public static final AbstractSubOrderReturnDelegate createDelegate() {
        if (prototype == null) {

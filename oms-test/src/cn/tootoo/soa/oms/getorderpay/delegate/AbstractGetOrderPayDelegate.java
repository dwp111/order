 ...
 * 接口remark：
 */
public abstract class AbstractGetOrderPayDelegate implements Cloneable {
     ...
     * 需子类实现。
     */
    public abstract AbstractGetOrderPayDelegate clone() throws CloneNotSupportedException;
    ...
    public final void init(final BaseInputBean inputBean, final BaseOutputBean outputBean) throws OmsDelegateException {
        ...
        if (inputBean.getInputData() != null) {
            if (!(inputBean.getInputData() instanceof OmsGetOrderPayInputData)) {
        ...
        /*调用子类方法。*/
        doInit(inputBean.getInputHead(), (OmsGetOrderPayInputData)inputBean.getInputData(), outputBean.getOutputHead(), (OmsGetOrderPayOutputData)outputBean.getOutputData());
    }
    ...
    public final boolean check(final BaseInputBean inputBean, final BaseOutputBean outputBean) {
        ...
        /*调用子类方法。*/
        return doCheck(inputBean.getInputHead(), (OmsGetOrderPayInputData)inputBean.getInputData(), outputBean.getOutputHead(), (OmsGetOrderPayOutputData)outputBean.getOutputData());
    }
    ...
    public final void execute(final BaseInputBean inputBean, final BaseOutputBean outputBean) throws OmsDelegateException {
        ...
        /*调用子类方法。*/
        doExecute(inputBean.getInputHead(), (OmsGetOrderPayInputData)inputBean.getInputData(), outputBean.getOutputHead(), (OmsGetOrderPayOutputData)outputBean.getOutputData());
    }
    ...
    public final void close(final BaseInputBean inputBean, final BaseOutputBean outputBean) throws OmsDelegateException {
        ...
        /*调用子类方法。*/
        doClose(inputBean.getInputHead(), (OmsGetOrderPayInputData)inputBean.getInputData(), outputBean.getOutputHead(), (OmsGetOrderPayOutputData)outputBean.getOutputData());
    }
     ...
     */
    public abstract void doInit(final BaseInputHead inputHead, final OmsGetOrderPayInputData inputData, final BaseOutputHead outputHead, final OmsGetOrderPayOutputData outputData) throws OmsDelegateException;
     ...
     * @return boolean 检查是否通过。
     */
    public abstract boolean doCheck(final BaseInputHead inputHead, final OmsGetOrderPayInputData inputData, final BaseOutputHead outputHead, final OmsGetOrderPayOutputData outputData);
     ...
     * @param outputData 该接口的返回结果数据体。
     */
    public abstract void doExecute(final BaseInputHead inputHead, final OmsGetOrderPayInputData inputData, final BaseOutputHead outputHead, final OmsGetOrderPayOutputData outputData) throws OmsDelegateException;
     ...
     * @param outputData 该接口的返回结果数据体。
     */
    public abstract void doClose(final BaseInputHead inputHead, final OmsGetOrderPayInputData inputData, final BaseOutputHead outputHead, final OmsGetOrderPayOutputData outputData) throws OmsDelegateException;
}
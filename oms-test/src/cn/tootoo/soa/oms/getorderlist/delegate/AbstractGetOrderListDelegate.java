 ...
 */
public abstract class AbstractGetOrderListDelegate implements Cloneable {
     ...
     * 需子类实现。
     */
    public abstract AbstractGetOrderListDelegate clone() throws CloneNotSupportedException;
    ...
    public final void init(final BaseInputBean inputBean, final BaseOutputBean outputBean) throws OmsDelegateException {
        ...
        if (inputBean.getInputData() != null) {
            if (!(inputBean.getInputData() instanceof OmsGetOrderListInputData)) {
        ...
        /*调用子类方法。*/
        doInit(inputBean.getInputHead(), (OmsGetOrderListInputData)inputBean.getInputData(), outputBean.getOutputHead(), (OmsGetOrderListOutputData)outputBean.getOutputData());
    }
    ...
    public final boolean check(final BaseInputBean inputBean, final BaseOutputBean outputBean) {
        ...
        /*调用子类方法。*/
        return doCheck(inputBean.getInputHead(), (OmsGetOrderListInputData)inputBean.getInputData(), outputBean.getOutputHead(), (OmsGetOrderListOutputData)outputBean.getOutputData());
    }
    ...
    public final void execute(final BaseInputBean inputBean, final BaseOutputBean outputBean) throws OmsDelegateException {
        ...
        /*调用子类方法。*/
        doExecute(inputBean.getInputHead(), (OmsGetOrderListInputData)inputBean.getInputData(), outputBean.getOutputHead(), (OmsGetOrderListOutputData)outputBean.getOutputData());
    }
    ...
    public final void close(final BaseInputBean inputBean, final BaseOutputBean outputBean) throws OmsDelegateException {
        ...
        /*调用子类方法。*/
        doClose(inputBean.getInputHead(), (OmsGetOrderListInputData)inputBean.getInputData(), outputBean.getOutputHead(), (OmsGetOrderListOutputData)outputBean.getOutputData());
    }
     ...
     */
    public abstract void doInit(final BaseInputHead inputHead, final OmsGetOrderListInputData inputData, final BaseOutputHead outputHead, final OmsGetOrderListOutputData outputData) throws OmsDelegateException;
     ...
     * @return boolean 检查是否通过。
     */
    public abstract boolean doCheck(final BaseInputHead inputHead, final OmsGetOrderListInputData inputData, final BaseOutputHead outputHead, final OmsGetOrderListOutputData outputData);
     ...
     * @param outputData 该接口的返回结果数据体。
     */
    public abstract void doExecute(final BaseInputHead inputHead, final OmsGetOrderListInputData inputData, final BaseOutputHead outputHead, final OmsGetOrderListOutputData outputData) throws OmsDelegateException;
     ...
     * @param outputData 该接口的返回结果数据体。
     */
    public abstract void doClose(final BaseInputHead inputHead, final OmsGetOrderListInputData inputData, final BaseOutputHead outputHead, final OmsGetOrderListOutputData outputData) throws OmsDelegateException;
}
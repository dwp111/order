 ...
 * 接口remark：
 */
public final class OrderCancelDelegateFactory {
    
    /**
     * 服务委托者原型对象。
     */
    private static AbstractOrderCancelDelegate prototype = null;
    
    /**
     * 服务委托者原型注册方法。
     */
    public static final void registPrototype(AbstractOrderCancelDelegate inPrototype) {
        if (inPrototype == null) {
     ...
     */
    public static final AbstractOrderCancelDelegate createDelegate() {
        if (prototype == null) {
